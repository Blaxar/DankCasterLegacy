...
void DkCst_get_int_param_test(void){
	...
	DkCst_set_int_param(params, "some other parameter", 4);
	int value;
	CU_ASSERT_EQUAL(DkCst_get_int_param(params, "some parameter", &value), OK);
	CU_ASSERT_EQUAL(value, 3);
	CU_ASSERT_EQUAL(DkCst_get_int_param(params, "some other parameter", &value), OK);
	CU_ASSERT_EQUAL(value, 4);
	CU_ASSERT_EQUAL(DkCst_get_int_param(params, "this one does not exist", &value), ERROR);
...
void DkCst_get_float_param_test(void){
	...
	DkCst_set_float_param(params, "some other parameter", (float)4.9999);
	float value;
	CU_ASSERT_EQUAL(DkCst_get_float_param(params, "some parameter", &value), OK);
	CU_ASSERT_EQUAL(value, (float)3.14);
	CU_ASSERT_EQUAL(DkCst_get_float_param(params, "some other parameter", &value), OK);
	CU_ASSERT_EQUAL(value, (float)4.9999);
	CU_ASSERT_EQUAL(DkCst_get_float_param(params, "this one does not exist", &value), ERROR);
...
void DkCst_get_string_param_test(void){
	...
	DkCst_set_string_param(params, "some other parameter", "O SHIT WADDUP");
    char *value;
	CU_ASSERT_EQUAL(DkCst_get_string_param(params, "some parameter", &value), OK);
	CU_ASSERT_EQUAL(strcmp("smok wed evryday", value), 0);
	CU_ASSERT_EQUAL(DkCst_get_string_param(params, "some other parameter", &value), OK);
	CU_ASSERT_EQUAL(strcmp("O SHIT WADDUP", value), 0);
	CU_ASSERT_EQUAL(DkCst_get_string_param(params, "this one does not exist", &value), ERROR);
...
void DkCst_unset_param_test(void){
	...
	DkCst_set_float_param(params, "some float parameter", (float)3.14);
	DkCst_set_string_param(params, "some other string  parameter", "O SHIT WADDUP");
	DkCst_set_int_param(params, "some int parameter", (int)200);
	DkCst_set_float_param(params, "some other float parameter", (float)41.3);
	DkCst_set_int_param(params, "some other int parameter", (int)-9999);

	float f_value;
	CU_ASSERT_EQUAL(DkCst_unset_param(params, "some other float parameter"),OK);
	CU_ASSERT_EQUAL(params->nb_params,5);
	CU_ASSERT_EQUAL(DkCst_get_float_param(params, "some other float parameter", &f_value), ERROR);
	CU_ASSERT_EQUAL(DkCst_unset_param(params, "some other float parameter"),ERROR);

	char *s_value;
	CU_ASSERT_EQUAL(DkCst_unset_param(params, "some string parameter"), OK);
	CU_ASSERT_EQUAL(params->nb_params,4);
	CU_ASSERT_EQUAL(DkCst_get_string_param(params, "some string parameter", &s_value), ERROR);
    CU_ASSERT_EQUAL(DkCst_unset_param(params, "some string parameter"), ERROR);

	char *i_value;
	CU_ASSERT_EQUAL(DkCst_unset_param(params, "some other int parameter"), OK);
	CU_ASSERT_EQUAL(params->nb_params,3);
	CU_ASSERT_EQUAL(DkCst_get_int_param(params, "some other int parameter", &i_value), ERROR);
    CU_ASSERT_EQUAL(DkCst_unset_param(params, "some other int parameter"), ERROR);

	CU_ASSERT_EQUAL(DkCst_get_string_param(params, "some other string  parameter", &s_value), OK);
	CU_ASSERT_EQUAL(strcmp("O SHIT WADDUP", s_value), 0);

	CU_ASSERT_EQUAL(DkCst_get_float_param(params, "some float parameter", &f_value), OK);
	CU_ASSERT_EQUAL(f_value, (float)3.14);

	CU_ASSERT_EQUAL(DkCst_get_int_param(params, "some int parameter", &i_value), OK);
	CU_ASSERT_EQUAL(i_value, (int)200);

	CU_ASSERT_EQUAL(DkCst_unset_param(params, "some other string  parameter"),OK);
	CU_ASSERT_EQUAL(DkCst_unset_param(params, "some float parameter"),OK);
	CU_ASSERT_EQUAL(DkCst_unset_param(params, "some int parameter"),OK);
	CU_ASSERT_EQUAL(params->nb_params, 0);
...
void DkCst_delete_param_pack_test(void){
	...
	CU_ASSERT_EQUAL(DkCst_delete_param_pack(params), ERROR);

	DkCst_unset_param(params, "some string parameter");
	DkCst_unset_param(params, "some float parameter");
	DkCst_unset_param(params, "some int parameter");
	
    CU_ASSERT_EQUAL(DkCst_delete_param_pack(&params), OK);
